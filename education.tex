\begin{rubric}{Formal Education \& Articles}
    ...
    \entry*
    \textbf{\htmladdnormallink{Thesis
    article}{http://www.cnxs.com.br/posts/my-thesis-short-article}}: about using
    the Getting Real philosophy as a way to be more competitive in an
    increasingly competitive and integrated world. 

    \entry*
    \textbf{\htmladdnormallink{Constructionism
    and university}{http://www.cnxs.com.br/learning_curve.pdf}}: an article
