\begin{rubric}{Technical Skills}{ 
   ...
   \entry* \textbf{Preferred development tool}: Vim in the old days,
    Emacs more recently, and
    \htmladdnormallink{DrRacket}{http://www.ccs.neu.edu/scheme/pubs/jfp01-fcffksf.pdf}
    for all schemy things. Although anything that provides a rich
    environment with fast feedback is fine.
